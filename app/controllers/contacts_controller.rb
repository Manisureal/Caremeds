class ContactsController < ApplicationController
  ...
  def create
    ...
    if @contact.valid? && verify_recaptcha(model: @contact)
      ...
      @new_contact = @api_client.post('contacts.json', {'first_name': @contact.first_name, 'last_name': @contact.last_name, 'emails': [{ 'type' => 'work', 'value' => @contact.email}], 'phones': [{ 'type' => 'other', 'value' => @contact.phone}], 'background': @contact.body} )
